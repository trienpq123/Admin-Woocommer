...
class CKFinder_Connector_Utils_FileSystem
{
     ...
     */
    const FILENAME_WITHOUT_EXTENSION = 'no_ext';
  ...
  'Û' => 'U', 'Þ' => 'Th', 'Ð' => 'Dh', 'Æ' => 'Ae', 'Ĕ' => 'E',
    ...
    */
    ...
    public static function autoRename( $filePath, $fileName )
    {
      ...
      $extension = CKFinder_Connector_Utils_FileSystem::getExtension($sFileNameOrginal, false);
      $iCounter = 0;
      ...
      while (true)
      {
        ...
        if ( file_exists($sFilePath) ){
          $iCounter++;
          $extensionPart = "(" . $iCounter . ")" . (!empty($extension) ? "." . $extension : '');
          $fileName = CKFinder_Connector_Utils_FileSystem::getFileNameWithoutExtension($sFileNameOrginal, false) . $extensionPart;
        }
        else
        {
          break;
