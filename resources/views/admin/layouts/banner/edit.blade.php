...
@section('articles')
    <div class="list-table">
        <div class="main" id="main">
            ...
            <form action="{{ route('admin.banner.putEditBanner', ['id' => $banner->id]) }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="grid gap-16">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Nhập tên ALT" class="form-control name" id="slug"
                            name="name" value="{{ $banner->title ?? old('name') }}">
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <div id="show-image" style="display:flex;align-items:center;flex-wrap: wrap; gap:10px;">
                            ...
                            <div class="form-group image-item" style="width:120px;height:120px; padding: 8px;background-color:#d9e1ef;">
                                <img src="{{$banner->link_img}}" alt="" style="height:100%; object-fit:cover;" />
                            </div>
                        </div>
                        <div class="form-group">
