                ...
                <div class="grid grid-tempalte-colum-7-3 gap-16">
                    <div class="form-left">
                        ...
                        <div class="form-group">
                            <div class="flex align-items-center justify-content-space-betweent">
                                ...
                                <button type="button" class="btn btn-modal btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#attribute">Thêm thuộc tính</button>
                    ...
                    <div class="form-right">
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-single brand form-control" name="idBrand" multiple="multiple">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" id="" class="add-file" id="upload-file" accept="image/*" multiple>
