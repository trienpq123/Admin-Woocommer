                ...
                <div class="box-alert">
                    <div class="form-feild">
                        ...
                        <form class="form-edit" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="">Tên Sản phẩm</label>
                                <input type="text" placeholder="Nhập tên Sản phẩm" class="form-control name_edit" id="slug" onchange="ChangeToSlug()" name="name">
                                <p class="name-error text text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Slug</label>
                                <input type="text" placeholder="Nhập tên Sản phẩm" class="form-control slug_edit" id="convert_slug" name="slug">
                                <p class="slug-error text text-danger"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Mã sản phẩm (SKU)</label>
                                <input type="text" placeholder="Nhập tên Sản phẩm" class="form-control product_sku_edit" id="product_sku" name="product_sku">
                                <p class="slug-error text text-danger"></p>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Hình ảnh</label>
                                <input type="file" name="image" id="" class="add-file-edit" id="upload-file" multiple>
                                <p class="image-error text text-danger"></p>
                            ...
                            <div class="form-group">
                                <input type="radio" name="status_edit" id="status_edit" class="status_edit" value="0" style="width:auto;"><label for="">Ẩn</label>
                                <input type="radio" name="status_edit" id="status_edit" class="status_edit" value="1" style="width:auto;"> <label for="">Hiện</label>
                            </div>
                            <div class="form-group">
                                <label for="">Chọn thương hiệu</label>
                                <select class="js-example-basic-single brand_edit form-control" name="id_brand" multiple="multiple">
                                    <option>Chưa chọn thương hiệu</option>
                                    @if (count($getBrands) > 0)
                                    @foreach ($getBrands as $item)
                                    <option value={{ $item->id_brand }}>{{ $item->name_brand }}</option>
            ...
            $('#table').DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, row, meta) {
                            return `<a href="{{route('admin.product.editProduct')}}?id=${data.id_product}" class="btn-edit"  data-name="edit-product" data-id="${data.id_product}">Chỉnh sửa</a>`
                        }
                    },
                    {
                        data: null,
