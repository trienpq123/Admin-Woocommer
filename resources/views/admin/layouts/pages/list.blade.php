                        ...
                        <div class="form-feild">
                            ...
                            <form id="form-add" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Nhập tên Trang" class="form-control slug"
                    ...
                    <div class="box-alert">
                        <div class="form-feild">
                            ...
                            <form class="form-edit" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="">Tên Trang</label>
                                    <input type="text" placeholder="Nhập tên Trang" class="form-control name_edit"
                                        id="slug" onchange="ChangeToSlug()" name="name">
                                    <p class="name-error text text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Slug</label>
                                    <input type="text" placeholder="Nhập tên Trang" class="form-control slug_edit"
                                        id="convert_slug" name="slug">
                                    <p class="slug-error text text-danger"></p>
                                </div>
                                <div class="form-group">
