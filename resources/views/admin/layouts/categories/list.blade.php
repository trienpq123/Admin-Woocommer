                ...
                <div class="form-feild">
                    ...
                    <form id="form-add" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên Danh mục" class="form-control slug"
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-single filter form-control" name="id_filter"
                                multiple="multiple">
            ...
            <div class="box-alert">
                <div class="form-feild">
                    ...
                    <form class="form-edit" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Tên danh mục</label>
                            <input type="text" placeholder="Nhập tên Danh mục" class="form-control edit_name"
                                id="slug" onchange="ChangeToSlug()" name="name">
                            <p class="name-error text text-danger"></p>
                        </div>
                        <div class="form-group">
                            <label for="">Slug</label>
                            <input type="text" placeholder="Nhập tên Danh mục" class="form-control edit_slug"
                                id="convert_slug" name="slug">
                            <p class="slug-error text text-danger"></p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="">Hình ảnh</label>
                            <input type="file" name="image" id="" class="file edit_file"
                                id="upload-file">
                            <p class="image-error text text-danger"></p>
                            <div class="form-group" id="show-file" style="width:120px;height:120px; padding-top: 8px">
                                <img class="1"
                        ...
                        <div class="form-group">
                            <input type="radio" name="status" id="status" class="edit_status" value="0"
                                style="width:auto;"><label for="">Ẩn</label>
                            <input type="radio" name="status" id="status" class="edit_status" value="1"
                                style="width:auto;"> <label for="">Hiện</label>
                        </div>
                        <div class="form-group">
                            <label for="">Chọn bộ lọc</label>
                            <select class="js-example-basic-single edit_filter form-control " name="id_filter"
                                multiple="multiple">
                        ...
                        <div class="form-group">
                            <label for="">Chọn Danh Mục Cha</label>
                            <select class="js-example-basic-single edit_parent_category  form-control"
