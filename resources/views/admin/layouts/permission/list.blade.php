    ...
    <div id="main" class="main">
        <div class="list-table">
            <div class="wrap-container">
                ...
                <a href="{{ route('admin.permisson.permisson.create') }}" class="btn btn-add" data-name="add-product">Thêm
                    mới</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($permission as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.permisson.permisson.edit', ['id' => $item->id]) }}"
                                            class="btn-edit" data-name="edit-product" data-id="{{ $item->id }}">Chỉnh
                                            sửa</a></td>
                                    {{-- class="btn-edit"  --}}
                                    <td><a href="{{ route('admin.permisson.permisson.delete', ['id' => $item->id]) }}"
