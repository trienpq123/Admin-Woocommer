                        ...
                        <tbody>
                            ...
                            @foreach ($role as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.roles.role.edit', ['id' => $item->id]) }}" class="btn-edit"
                                            data-name="edit-product" data-id="{{ $item->id }}">
                                            <span><i class="ri-edit-box-line"></i></span>
                                        </a></td>
                                    {{-- class="btn-edit"  --}}
                                    <td><a href="{{ route('admin.roles.role.delete', ['id' => $item->id]) }}"
                                            class="btn-delete"><span><i class="ri-delete-bin-5-line"></i></span></a></td>
                                </tr>
                            @endforeach
                        </tbody>
